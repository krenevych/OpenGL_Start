...
int main(void)
{
    ...
    // unsigned int indices[] = {  // correct indices
    //     0, 2, 1,    2, 0, 3,       // передня (червона)
    //     4, 5, 6,    6, 7, 4,       // задня (зелена)
    //     8, 10, 9,   10,8,11,       // ліва (синя)
    //    12,13,14,   14,15,12,       // права (жовта)
    //    16,18, 17,  18,16,19,       // нижня (бірюзова)
    //    20,22,21,   22,20,23        // верхня (фіолетова)
    // };
    ...
    glVertexAttribPointer(
        ...
        GL_FLOAT,           // тип даних
        GL_FALSE,           // не нормалізувати
        6 * sizeof(float),  // stride: 4 float-а на вершину
