...
int main(void)
{
    ...
    float vertices[] = {
        // -------- Передня грань --------
        0.0f, 0.0f, 0.0f,    /* текстурні координати */  0.0, 0.0,
        1.0f, 0.0f, 0.0f,    /* текстурні координати */  1.0, 0.0,
        1.0f, 1.0f, 0.0f,    /* текстурні координати */  1.0, 1.0,
        0.0f, 1.0f, 0.0f,    /* текстурні координати */  0.0, 1.0,

       // -------- Задня грань --------
        0.0f, 0.0f, 1.0f,    /* текстурні координати */  0.0, 0.0,
        1.0f, 0.0f, 1.0f,    /* текстурні координати */  1.0, 0.0,
        1.0f, 1.0f, 1.0f,    /* текстурні координати */  1.0, 1.0,
        0.0f, 1.0f, 1.0f,    /* текстурні координати */  0.0, 1.0,

       // -------- Ліва грань (синя) --------
        0.0f, 0.0f, 0.0f,    /* текстурні координати */  0.0, 0.0,
        0.0f, 1.0f, 0.0f,    /* текстурні координати */  0.0, 1.0,
        0.0f, 1.0f, 1.0f,    /* текстурні координати */  1.0, 1.0,
        0.0f, 0.0f, 1.0f,    /* текстурні координати */  1.0, 0.0,

       // -------- Права грань --------
        1.0f, 0.0f, 0.0f,    /* текстурні координати */  0.0, 0.0,
        1.0f, 1.0f, 0.0f,    /* текстурні координати */  0.0, 1.0,
        1.0f, 1.0f, 1.0f,    /* текстурні координати */  1.0, 1.0,
        1.0f, 0.0f, 1.0f,    /* текстурні координати */  1.0, 0.0,
       ...
       // -------- Нижня грань --------
        0.0f, 0.0f, 0.0f,    /* текстурні координати */  0.0, 0.0,
        0.0f, 0.0f, 1.0f,    /* текстурні координати */  1.0, 0.0,
        1.0f, 0.0f, 1.0f,    /* текстурні координати */  1.0, 1.0,
        1.0f, 0.0f, 0.0f,    /* текстурні координати */  0.0, 1.0,

       // -------- Верхня грань --------
        0.0f, 1.0f, 0.0f,    /* текстурні координати */  0.0, 0.0,
        1.0f, 1.0f, 0.0f,    /* текстурні координати */  1.0, 0.0,
        1.0f, 1.0f, 1.0f,    /* текстурні координати */  1.0, 1.0,
        0.0f, 1.0f, 1.0f,    /* текстурні координати */  0.0, 1.0,
   };
